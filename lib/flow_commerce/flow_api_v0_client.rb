...
# apidoc:0.11.51 http://www.apidoc.me/flow/api/0.2.26/ruby_client
    ...
    module V0
      ...
      class Client
        ...
        module Constants
          ...
          USER_AGENT = 'apidoc:0.11.51 http://www.apidoc.me/flow/api/0.2.26/ruby_client' unless defined?(Constants::USER_AGENT)
      ...
      module Models
        ...
        class CardDeleted < Event
          ...
          attr_reader :event_id, :timestamp, :organization, :token, :id

          def initialize(incoming={})
            super(:discriminator => Event::Types::CARD_DELETED)
            opts = HttpClient::Helper.symbolize_keys(incoming)
            HttpClient::Preconditions.require_keys(opts, [:event_id, :timestamp, :organization], 'CardDeleted')
            @event_id = HttpClient::Preconditions.assert_class('event_id', opts.delete(:event_id), String)
            @timestamp = HttpClient::Preconditions.assert_class('timestamp', HttpClient::Helper.to_date_time_iso8601(opts.delete(:timestamp)), DateTime)
            @organization = HttpClient::Preconditions.assert_class('organization', opts.delete(:organization), String)
            @token = (x = opts.delete(:token); x.nil? ? nil : HttpClient::Preconditions.assert_class('token', x, String))
        ...
        class CardUpserted < Event
          ...
          attr_reader :event_id, :timestamp, :id, :organization, :token, :type, :expiration, :iin, :last4, :name, :address

          def initialize(incoming={})
            super(:discriminator => Event::Types::CARD_UPSERTED)
            opts = HttpClient::Helper.symbolize_keys(incoming)
            HttpClient::Preconditions.require_keys(opts, [:event_id, :timestamp, :organization, :type, :expiration, :iin, :last4, :name], 'CardUpserted')
            @event_id = HttpClient::Preconditions.assert_class('event_id', opts.delete(:event_id), String)
            @timestamp = HttpClient::Preconditions.assert_class('timestamp', HttpClient::Helper.to_date_time_iso8601(opts.delete(:timestamp)), DateTime)
            @id = (x = opts.delete(:id); x.nil? ? nil : HttpClient::Preconditions.assert_class('id', x, String))
            @organization = HttpClient::Preconditions.assert_class('organization', opts.delete(:organization), String)
        ...
        class OrderUpserted < Event
          ...
          attr_reader :event_id, :timestamp, :organization, :number, :environment, :experience_id, :expires_at, :customer, :selections, :items, :destination, :deliveries, :prices, :discount, :total, :lines
