module Util
  ...
  MENU = [
    ...
    Util::MenuItem.new("Experience: Copy", "examples/copy_one_experience.rb", Proc.new { |client, org| CopyOneExperience.run(client, org) }),
    ...
    Util::MenuItem.new("Order: Create order", "examples/create_order.rb", Proc.new { |client, org| CreateOrder.run(client, org) })
  ]
